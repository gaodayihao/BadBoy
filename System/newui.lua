...
function bb.ui:createConfigWindow()
    ...
    local function callGeneral()
        ...
        bb.ui:createSpinnerWithout(section,  LC_ROTATION_TPS ,15, 1, 30, 1, "", LC_ROTATION_DESCRIPTION)
        bb.ui:createSpinnerWithout(section,  LC_UNITS_TPS ,5, 1, 10, 1, "", LC_UNITS_TPS_DESCRIPTION)
