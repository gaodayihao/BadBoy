...
---------------
    local function createOptions()
        ...
        -- General Options
            ...
            -- APL
                br.ui:createDropdownWithout(section, "APL Mode", {"|cffFFFFFFSimC710-01","|cffFFFFFFAMR"}, 1, "|cffFFFFFFSet APL Mode to use.")
            -- Dummy DPS Test
        ...
        -- Cooldown Options
            ...
            -- Potion
                br.ui:createDropdown(section, "Potion", {"|cffFFFF00Old War","|cffFF0000Prolonged Power"}, 1)
            -- Flask / Crystal
